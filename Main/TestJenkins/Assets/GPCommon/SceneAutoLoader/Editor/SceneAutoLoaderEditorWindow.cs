...
{
	[MenuItem("GPCommon/Scene Auto Loader")]
	static void Init()
	{
	...
	{
		bool previousLoadMasterOnPlay = SceneAutoLoaderProperties.LoadMasterOnPlay;
		...
		if (newLoadMasterOnPlay != previousLoadMasterOnPlay)
			SceneAutoLoaderProperties.LoadMasterOnPlay = newLoadMasterOnPlay;
	...
	{
		string previousMasterScene = SceneAutoLoaderProperties.MasterScene;
		...
		if (newMasterScene != previousMasterScene)
			SceneAutoLoaderProperties.MasterScene = newMasterScene;
	}
